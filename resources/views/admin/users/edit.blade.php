                ...
                <div class="col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('users.update',['user'=>$user->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="codemelli" id="exampleInputEmail111" value="{{ $user->codemelli }}">
                        </div>
                        <div class="form-group">
                            <label for="phone">تلفن</label>
                            <input type="text" class="form-control" name="phone" id="exampleInputEmail12" value="{{ $user->phone }}">
                        </div>
